 ...
 */
static VkSurfaceKHR createVkSurface(WGPUDevice device, WindowHandle window) {
 ...
 * the \c #swapPref.
 */
static void initSwapChain(WGPUBackendType backend, WGPUDevice device, rush::WindowHandle window) {
	switch (backend) {
#ifdef DAWN_ENABLE_BACKEND_D3D12
...
namespace webgpu
{
    ...
    WGPUDevice create(rush::WindowHandle window, WGPUBackendType type)
	{
