#include "stdafx.h"
#include "render/fg/PassNode.hpp"
#include <cassert>

namespace {

    [[nodiscard]] bool hasId(const std::vector<rush::FrameGraphResource>& v, rush::FrameGraphResource id) {
#if __cpp_lib_ranges
    ...
    [[nodiscard]] bool hasId(const std::vector<rush::PassNode::AccessDeclaration>& v, rush::FrameGraphResource id) {
    ...
    [[nodiscard]] bool contains(const std::vector<rush::PassNode::AccessDeclaration>& v, rush::PassNode::AccessDeclaration n) {
#if __cpp_lib_ranges
