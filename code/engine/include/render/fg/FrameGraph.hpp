#ifndef FrameGraph_h__
#define FrameGraph_h__

#include "render/fg/TypeTraits.hpp"
...
namespace rush
{
    ...
    public:
        ...
        public:
            ...
            [[nodiscard]] FrameGraphResource create(const std::string_view name, typename T::Desc);
...
#include "render/fg/FrameGraph.inl"

#endif // FrameGraph_h__
